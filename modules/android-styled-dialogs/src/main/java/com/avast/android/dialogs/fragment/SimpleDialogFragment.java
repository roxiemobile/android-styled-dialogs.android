...
public class SimpleDialogFragment extends BaseDialogFragment {
    ...
    protected View getCustomView() {
        return mDialogHolder.mCustomView;
    }
    ...
    {
        ISimpleDialogListener mDialogListener;
        View mCustomView;
    }
    ...
    public static class SimpleDialogBuilder extends BaseDialogBuilder<SimpleDialogBuilder>
    {
        ...
        public SimpleDialogBuilder setView(View view) {
            mDialogHolder.mCustomView = view;
            return this;
        }
        ...
        public SimpleDialogBuilder setDialogListener(ISimpleDialogListener listener) {
        ...
        protected void prepareDialogFragment(BaseDialogFragment fragment) {
            ...
            if (fragment instanceof SimpleDialogFragment) {
                ((SimpleDialogFragment) fragment).setDialogHolder(mDialogHolder);
            }
        }
    }
}
